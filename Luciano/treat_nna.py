...
nuevo_directorio = r"C:\Users\langh\OneDrive\Desktop\DATA Sc\Fil Rouge"

os.chdir(nuevo_directorio)

print(os.getcwd())
fichier_data = "weatherAUS.csv"
...
# Compter le nombre de lignes avant tout processus
nombre_lignes_original = len(df_cleaned_data)
...
nombre_lignes_apres1 = len(df_cleaned_data)
pourcentage_supprime1 = ((nombre_lignes_original - nombre_lignes_apres1) / nombre_lignes_original) * 100
...
nombre_lignes_apres2 = len(df_cleaned_data)
pourcentage_supprime2 = ((nombre_lignes_apres1 - nombre_lignes_apres2) / nombre_lignes_original) * 100

print(f"Pourcentage de valeurs supprimées pour RainTomorrow 1 : {pourcentage_supprime1:.2f}%")
print(f"Pourcentage de valeurs supprimées dpour NaN>50% 2 : {pourcentage_supprime2:.2f}%")
