...
class ProjetAustralieSoutenance_1a3:
    ...
    def generate_density_plots(self):      
        ...
        # Charger dataframes
        df_cleaned_data = pd.read_csv(path_datasets+"weatherAUS.csv")
        df_imputed_inverse_2 = pd.read_csv(f"{path_datasets}\\df_imputed_inverse_2.csv", sep=';')
        df_imputed_inverse_3 = pd.read_csv(f"{path_datasets}\\df_imputed_inverse_3.csv", sep=';')
        df_imputed_inverse_4 = pd.read_csv(f"{path_datasets}\\df_imputed_inverse_4.csv", sep=';')
        df_imputed_by_mean = pd.read_csv(f"{path_datasets}\\df_imputed_by_mean.csv", sep=';')
        df_imputed_by_median = pd.read_csv(f"{path_datasets}\\df_imputed_by_median.csv", sep=';')
